...
export function buildRiseEmbedSnippet(options = {}) {
  ...
  const title = options.title || 'PMI Interactive Block';
...
export async function buildCoursePackZip({ courseTitle = 'PMI Course Interactions Pack', components = [] }) {
  const entries = [];
  const manifestItems = [];
...
<body>
  <div class="container">
    <div class="header">
      ...
      <p class="desc">Interactive eLearning interaction package generated by the PMI Rise Component Builder. Select any component below to launch or preview.</p>
    </div>
    <div class="grid">
