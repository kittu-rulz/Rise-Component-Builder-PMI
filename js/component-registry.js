...
import { getPmiIconSvg } from './pmi-icons.js';
...
export const COMPONENT_REGISTRY = [
  fromModule(accordion, {
    ...
    icon: getPmiIconSvg('list', { width: 24, height: 24, ariaHidden: true }),
  ...
  fromModule(flipCards, {
    ...
    icon: getPmiIconSvg('question-circle-filled', { width: 24, height: 24, ariaHidden: true }),
    classification: 'enhanced',
  ...
  fromModule(tabs, {
    ...
    icon: getPmiIconSvg('folder', { width: 24, height: 24, ariaHidden: true }),
    classification: 'enhanced',
  ...
  fromModule(hotspots, {
    ...
    icon: getPmiIconSvg('hotspot', { width: 24, height: 24, ariaHidden: true }),
    classification: 'enhanced',
  ...
  fromModule(buttonList, {
    ...
    icon: getPmiIconSvg('open-new', { width: 24, height: 24, ariaHidden: true }),
    classification: 'enhanced',
  ...
  fromModule(menuList, {
    ...
    icon: getPmiIconSvg('message-3', { width: 24, height: 24, ariaHidden: true }),
  ...
  fromModule(multipleChoice, {
    ...
    icon: getPmiIconSvg('check-circle-filled', { width: 24, height: 24, ariaHidden: true }),
    classification: 'enhanced',
  ...
  fromModule(multipleSelect, {
    ...
    icon: getPmiIconSvg('check-circle', { width: 24, height: 24, ariaHidden: true }),
    classification: 'enhanced',
  ...
  fromModule(sortingActivity, {
    ...
    icon: getPmiIconSvg('arrows-vertical-1', { width: 24, height: 24, ariaHidden: true }),
    classification: 'enhanced',
  ...
  fromModule(fillBlank, {
    ...
    icon: getPmiIconSvg('pencil', { width: 24, height: 24, ariaHidden: true }),
    classification: 'enhanced',
  ...
  fromModule(verticalTimeline, {
    ...
    icon: getPmiIconSvg('clock', { width: 24, height: 24, ariaHidden: true }),
    classification: 'enhanced',
  ...
  fromModule(horizontalTimeline, {
    ...
    icon: getPmiIconSvg('arrow-right', { width: 24, height: 24, ariaHidden: true }),
    classification: 'custom',
  ...
  fromModule(processFlow, {
    ...
    icon: getPmiIconSvg('step-forward', { width: 24, height: 24, ariaHidden: true }),
    classification: 'enhanced',
  ...
  fromModule(scenario, {
    ...
    icon: getPmiIconSvg('message-2', { width: 24, height: 24, ariaHidden: true }),
    classification: 'enhanced',
  ...
  fromModule(profileCards, {
    ...
    icon: getPmiIconSvg('person', { width: 24, height: 24, ariaHidden: true }),
    classification: 'custom',
  ...
  fromModule(infoGrid, {
    ...
    icon: getPmiIconSvg('grid', { width: 24, height: 24, ariaHidden: true }),
    classification: 'enhanced',
  ...
  fromModule(pricingComparison, {
    ...
    icon: getPmiIconSvg('tag', { width: 24, height: 24, ariaHidden: true }),
    classification: 'custom',
  ...
  fromModule(audioPlayer, {
    ...
    icon: getPmiIconSvg('volume-3', { width: 24, height: 24, ariaHidden: true }),
    classification: 'custom',
  ...
  fromModule(videoFrame, {
    ...
    icon: getPmiIconSvg('play', { width: 24, height: 24, ariaHidden: true }),
    classification: 'custom',
  ...
  fromModule(imageGallery, {
    ...
    icon: getPmiIconSvg('photo-gallery', { width: 24, height: 24, ariaHidden: true }),
    classification: 'enhanced',
  ...
  fromModule(interactiveVideo, {
    ...
    status: 'beta',
    icon: getPmiIconSvg('information-circle-filled', { width: 24, height: 24, ariaHidden: true }),
    classification: 'custom',
  ...
  fromModule(comparisonSlider, {
    ...
    icon: getPmiIconSvg('arrows-horizontal', { width: 24, height: 24, ariaHidden: true }),
    classification: 'custom',
  ...
  fromModule(dialGauge, {
    ...
    icon: getPmiIconSvg('high-meter', { width: 24, height: 24, ariaHidden: true }),
    classification: 'custom',
  ...
  fromModule(calloutBox, {
    ...
    icon: getPmiIconSvg('information-circle-filled', { width: 24, height: 24, ariaHidden: true }),
    classification: 'custom',
    differentiator: 'Multi-card alert matrix with PMI brand tones, responsive grid layouts, and interactive learner acknowledgment.',
    tier: 'enhanced-rise',
    ...
    keyCapabilities: ['Multi-tone brand palette (Information, Policy, Warning, Tip)', 'Interactive "I Acknowledge" checkbox gate', 'Multi-card alert grid layout', 'Custom PMI iconography', 'Compliance acknowledgment tracking'],
    complexity: 'Basic',
    mediaRequirements: 'None',
  ...
  fromModule(cardCarousel, {
    ...
    icon: getPmiIconSvg('multi-screen', { width: 24, height: 24, ariaHidden: true }),
    classification: 'custom',
  ...
  fromModule(confidenceMatrix, {
    ...
    icon: getPmiIconSvg('check-shield', { width: 24, height: 24, ariaHidden: true }),
    classification: 'custom',
